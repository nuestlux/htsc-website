(function () {
  ...
  const translations = {
    vi: {
      ...
      "eyebrow.ecosystem": "Hệ sinh thái HTSC",
      "ecosystem.title": "Đồng hành cùng các đối tác, hiệp hội và sự kiện công nghệ uy tín.",
      "ecosystem.note": "HTSC kết nối năng lực AI, an ninh và đô thị thông minh qua các hoạt động hợp tác, triển lãm chuyên ngành và hệ sinh thái công nghệ liên quan.",
    ...
    en: {
      ...
      "eyebrow.ecosystem": "HTSC ecosystem",
      "ecosystem.title": "Working with trusted technology partners, associations and industry events.",
      "ecosystem.note": "HTSC connects AI, security and smart city capabilities through partnerships, specialist exhibitions and related technology ecosystems.",
