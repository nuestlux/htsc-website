...
const images = {
  hero: "https://htsc.vn/wp-content/uploads/2021/10/Asset-1-100-min.jpg",
  about: "https://htsc.vn/wp-content/uploads/2021/10/asset-3-100-min-1.jpg",
  career: "https://htsc.vn/wp-content/uploads/2021/10/career-path-htsc.jpg",
  news: "https://htsc.vn/wp-content/uploads/2021/10/banner-htsc-1.png",
...
function pageHero({ number = "01", eyebrow, title, text, image, actions = "", breadcrumbs = [] }) {
  return `
    <section class="page-hero grid-lines">
    ...
    <section class="hero">
      <div class="swiper hero-swiper">
        <div class="swiper-wrapper">
          ...
          <article class="swiper-slide hero-slide" style="--hero-image: url('${products[1].image}');">
            <div class="hero-content">
